...
const EditStudent = ({handleEditStudent,id,error}) => {
  const {
    register,
    handleSubmit,
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:8080/api/v1/students/details/${id}`)
  ...
  return (
    <div>
      <h1 className="text-center  font-bold text-4xl my-5">Edit Student</h1>
      ...
      <section className=" w-1/2 mx-auto">
        ...
        <form className="w-full    min-h-screen " onSubmit={handleSubmit(handleEditStudent)}>
          <div className=" mb-4">
